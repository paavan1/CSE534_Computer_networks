...
main (int argc, char *argv[])
{
  ...
  // on the first consumer node install a Consumer application
  // that will express interests in /dst1 namespace
  consumerHelper2.SetPrefix ("/Producer2");
  ...
  //consumerHelper.SetPrefix ("/Producer2");
  //consumerHelper.Install (consumer2);
  ...
  ndnGlobalRoutingHelper.AddOrigins ("/Producer1", producer1);
  ...
  ndnGlobalRoutingHelper.AddOrigins ("/Producer2", producer2);
  ...
  ndn::AppDelayTracer::InstallAll ("a2app-delays-trace.txt");
  Simulator::Run ();
  Simulator::Destroy ();
